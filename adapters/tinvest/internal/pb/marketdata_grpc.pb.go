...
const (
	...
	MarketDataService_GetMarketValues_FullMethodName    = "/tinkoff.public.invest.api.contract.v1.MarketDataService/GetMarketValues"
)
...
type MarketDataServiceClient interface {
	...
	GetMarketValues(ctx context.Context, in *GetMarketValuesRequest, opts ...grpc.CallOption) (*GetMarketValuesResponse, error)
}
...
func (c *marketDataServiceClient) GetMarketValues(ctx context.Context, in *GetMarketValuesRequest, opts ...grpc.CallOption) (*GetMarketValuesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMarketValuesResponse)
	err := c.cc.Invoke(ctx, MarketDataService_GetMarketValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MarketDataServiceServer interface {
	...
	// GetMarketValues — рыночные данные по инструментам
	GetMarketValues(context.Context, *GetMarketValuesRequest) (*GetMarketValuesResponse, error)
...
func (UnimplementedMarketDataServiceServer) GetLastPrices(context.Context, *GetLastPricesRequest) (*GetLastPricesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLastPrices not implemented")
}
...
func (UnimplementedMarketDataServiceServer) GetTradingStatuses(context.Context, *GetTradingStatusesRequest) (*GetTradingStatusesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTradingStatuses not implemented")
}
...
func (UnimplementedMarketDataServiceServer) GetClosePrices(context.Context, *GetClosePricesRequest) (*GetClosePricesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClosePrices not implemented")
}
func (UnimplementedMarketDataServiceServer) GetTechAnalysis(context.Context, *GetTechAnalysisRequest) (*GetTechAnalysisResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTechAnalysis not implemented")
}
func (UnimplementedMarketDataServiceServer) GetMarketValues(context.Context, *GetMarketValuesRequest) (*GetMarketValuesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMarketValues not implemented")
}
...
func _MarketDataService_GetMarketValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMarketValuesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MarketDataServiceServer).GetMarketValues(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MarketDataService_GetMarketValues_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MarketDataServiceServer).GetMarketValues(ctx, req.(*GetMarketValuesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MarketDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMarketValues",
			Handler:    _MarketDataService_GetMarketValues_Handler,
		},
	},
...
func (UnimplementedMarketDataStreamServiceServer) MarketDataStream(grpc.BidiStreamingServer[MarketDataRequest, MarketDataResponse]) error {
	return status.Error(codes.Unimplemented, "method MarketDataStream not implemented")
}
func (UnimplementedMarketDataStreamServiceServer) MarketDataServerSideStream(*MarketDataServerSideStreamRequest, grpc.ServerStreamingServer[MarketDataResponse]) error {
	return status.Error(codes.Unimplemented, "method MarketDataServerSideStream not implemented")
}
...
func RegisterMarketDataStreamServiceServer(s grpc.ServiceRegistrar, srv MarketDataStreamServiceServer) {
	// If the following call panics, it indicates UnimplementedMarketDataStreamServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
